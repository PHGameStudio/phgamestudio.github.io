...
2. **Test locally**: Always run `jekyll serve` inside `nix develop` and verify your changes work.
...
| Symptom                           | Fix                                                                    |
| --------------------------------- | ---------------------------------------------------------------------- |
| `nix` command not found           | Ensure Nix is installed and added to your PATH.                        |
